    ...
    <label className={classNames(disabled ? 'opacity-50' : '', className)}>
      ...
      <div
        className={classNames(
          'relative box-content inline-block flex-shrink-0 cursor-pointer rounded-full border-2 border-solid border-transparent bg-clip-padding ',
      ...
      >
        <div
          className={classNames(
            'absolute top-1/2 block -translate-y-1/2 rounded-full bg-default',
